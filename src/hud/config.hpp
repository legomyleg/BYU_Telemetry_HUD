...
inline constexpr float TEXT_SIZE = 20.0f;
inline constexpr float HEADER_SIZE = 25.0f;
...
inline constexpr float BOX_HEADER_SIZE = 25.0f;
inline constexpr float SUBHEADER_TEXT_SIZE = 10.0f;
inline constexpr float READOUT_TEXT_SIZE = 15.0f;
